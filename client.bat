...
CALL %ExePath% %ProjectPath% -debug -game -log -AUTH_TYPE=%AUTH_TYPE% -AUTH_LOGIN=%AUTH_LOGIN% -AUTH_PASSWORD=%AUTH_PASSWORD% -epicapp=%epicapp% -ResX=1280 -ResY=720 -windowed
